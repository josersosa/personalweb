...
|Péndulo Caótico ||
| :---: | :--- |
| <img src="../../images/Double-compound-pendulum.gif" /> | Recordando el efecto mariposa, el péndulo doble es uno de los sistemas caóticos más simples. Si se lanza, dando posiciones iniciales ligeramente diferentes cada vez, se obtienen trayectorias completamente distintas. |
