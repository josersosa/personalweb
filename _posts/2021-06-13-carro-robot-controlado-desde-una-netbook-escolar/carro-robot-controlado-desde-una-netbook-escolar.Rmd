...
Como se puede ver, establece una red llamada "robotland" en el canal 10.  Podemos ver que canales estan disponibles en nuestro entorno con el  comando "iwlist wlan0 scan". El dispositivo utilizado es wlan0, pero  puede variar de computador en computado. Por ultimo, la dirección IP  asignada al equipo Canaimita fue 192.168.1.1 y al equipo remoto  192.168.1.2. A continuacion podemos ver una muestra del movimineto de  nuestro robot controlado por una netbook Canaimita:


<iframe src="http://www.youtube.com/embed/c3hgV1xzBFc?rel=0&amp;fs=1&amp;wmode=transparent" allowfullscreen="" title="JoomlaWorks AllVideos Player" width="400" height="300" frameborder="0">
</iframe>
...
<iframe src="http://www.youtube.com/embed/8yqqVgX1F_I?rel=0&amp;fs=1&amp;wmode=transparent" allowfullscreen="" title="JoomlaWorks AllVideos Player" width="400" height="300" frameborder="0">
</iframe>
